...
.. note::
    ...
    .. code-block:: bash
        ...
        WAVES fetch
        Destination directory: '/home/roppenheimer/waves-tutorials'
        $ waves fetch tutorials/eabm_package/python/rectangle_compression_sobol_sequence.py && mv rectangle_compression_sobol_sequence.py eabm_package/python/
        WAVES fetch
        Destination directory: '/home/roppenheimer/waves-tutorials'
...
.. code-block:: bash
   ...
   $ pwd
   /home/roppenheimer/waves-tutorials
   $ waves fetch tutorials/tutorial_07_sobol_sequence && cp tutorial_07_sobol_sequence tutorial_extend_study
   WAVES fetch
   Destination directory: '/home/roppenheimer/waves-tutorials'
