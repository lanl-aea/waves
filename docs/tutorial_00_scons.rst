...
:meth:`waves.scons.add_program` method wraps `CheckProg`_ to search for a list of possible program names. This is
...
The :meth:`waves.scons.project_help_message` wraps two common calls to the `SCons Help`_ construction environment
...
The help messages are added to the construction environment, so the :meth:`waves.scons.project_help_message` call
...
:meth:`waves.scons.project_help_message` as the final line in your project configuration.
