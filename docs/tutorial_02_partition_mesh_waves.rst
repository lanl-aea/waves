...
* `Abaqus Node Sets`_ :cite:`ABAQUS2022`
* `Abaqus Element Sets`_ and `Abaqus Elements Guide`_ :cite:`ABAQUS2022`
* `Abaqus Surfaces`_ :cite:`ABAQUS2022`
* `Abaqus Assembly Definition`_ :cite:`ABAQUS2022`
...
* Within the new ``output_file``, do the following:
  ...
  * Create node sets at four corners of the single element part. See the `Abaqus Node Sets`_ documentation :cite:`ABAQUS2022` for more
    information about node sets.
  * Create surfaces for the four sides of the single element part. See the `Abaqus Surfaces`_ documentation :cite:`ABAQUS2022` for more
...
an `Abaqus Model Object`_ :cite:`ABAQUS2022` along with a ``part_name`` and ``orphan_mesh_file`` name to create an
...
* Create a part instance that can be meshed. See the `Abaqus Assembly Definition`_ documentation :cite:`ABAQUS2022` for
...
* Mesh the part
* Assign an element type to the part. See the `Abaqus Elements Guide`_ :cite:`ABAQUS2022` for more information about
  defining element types.
* Define element and node sets for elements and nodes that may require output requests in the model. See the `Abaqus
  Element Sets`_ documentation :cite:`ABAQUS2022` for more information about element sets.
