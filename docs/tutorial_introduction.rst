...
discussion and start with the simulation definitions directly in :ref:`tutorialgeometrywaves`.
...
------------------------ -------------------------------------------- ---------------------------------------------------------
                   ...
                   01:00 :ref:`tutorialgeometrywaves`                 Hierarchical `SCons`_ builds, task creation, Abaqus
                   ...
                   00:20 :ref:`tutorial_parameter_substitution_waves` Parameterized builds and substituting parameter values
                                                                      into copied files
                   00:20 :ref:`tutorial_include_files_waves`          Including files that can be re-used in more than one
                                                                      workflow
