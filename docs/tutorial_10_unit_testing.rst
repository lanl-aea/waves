...
4. In the ``waves-tutorials/modsim_package/python/tests`` directory, Create a new file named ``test_post_processing.py`` from the contents below

.. admonition:: waves-tutorials/modsim_package/python/tests/test_post_processing.py

    .. literalinclude:: tests_test_post_processing.py
        :language: Python
        :lineno-match:

In the ``test_post_processing.py`` file, you'll find a test implementation of two simple functions within the
