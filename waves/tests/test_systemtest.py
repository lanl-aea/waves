...
@pytest.mark.parametrize("command, directory", [
    ...
    ("scons unit_testing --sconstruct=tutorial_10_unit_testing_SConstruct --unconditional-build --print-build-failures", tutorial_directory),
    ("scons tutorial_sensitivity_study --sconstruct=tutorial_sensitivity_study_SConstruct --jobs=4 --unconditional-build --print-build-failures", tutorial_directory),
