...
def test_main():
    ...
    with patch("waves._parameter_study.read_parameter_schema", side_effect=yaml.parser.ParserError()), \
    ...
    for subcommand, generator in associations:
        mock_generator = Mock()
        with patch("waves._parameter_study.read_parameter_schema", return_value={}), \
