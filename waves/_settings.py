...
_tutorial_paths: dict[_allowable_tutorial_numbers_typing, list[pathlib.Path]] = {
    ...
    1: [
        ...
        pathlib.Path("tutorials/tutorial_01_geometry.scons"),
    ...
    2: [
        ...
        pathlib.Path("tutorials/tutorial_02_partition_mesh.scons"),
    ...
    3: [
        ...
        pathlib.Path("tutorials/tutorial_03_solverprep.scons"),
        pathlib.Path("tutorials/tutorial_03_solverprep_SConstruct"),
    ],
    4: [
        pathlib.Path("tutorials/tutorial_04_simulation.scons"),
    ...
    5: [
        ...
        pathlib.Path("tutorials/tutorial_05_parameter_substitution.scons"),
    ...
    6: [
        ...
        pathlib.Path("tutorials/tutorial_06_include_files.scons"),
    ...
    7: [
        ...
        pathlib.Path("tutorials/tutorial_07_cartesian_product.scons"),
        pathlib.Path("tutorials/tutorial_07_cartesian_product_SConstruct"),
    ],
    8: [
        pathlib.Path("tutorials/tutorial_08_data_extraction.scons"),
    ...
    9: [
        ...
        pathlib.Path("tutorials/tutorial_09_post_processing.scons"),
    ...
    10: [
        ...
        pathlib.Path("tutorials/unit_testing.scons"),
    ...
    11: [
        ...
        pathlib.Path("tutorials/tutorial_11_regression_testing.scons"),
        pathlib.Path("tutorials/tutorial_11_regression_testing_SConstruct"),
    ],
    12: [
        pathlib.Path(
            "tutorials/tutorial_12_archival.scons",
        ),
