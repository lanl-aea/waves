...
_tutorial_paths = {0: [{'files': ['tutorials/tutorial_00_SConstruct'],
                        'destination': pathlib.Path().cwd()}],
                   1: [{'files': ['tutorials/modsim_package/__init__.py'],
                        'destination': 'modsim_package'},
                       {'files': ['tutorials/modsim_package/abaqus/__init__.py',
                                  'tutorials/modsim_package/abaqus/rectangle_geometry.py'],
                        'destination': 'modsim_package/abaqus'},
                       {'files': ['tutorials/tutorial_01_geometry_SConstruct'],
                        'destination': pathlib.Path().cwd()}],
                   2: [{'files': [],
                        'destination': ''},
                       {'files': [],
