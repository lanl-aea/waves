...
_tutorial_paths = {0: [],
                   1: [{'files': ['tutorials/modsim_package/abaqus/__init__.py',
                                  'tutorials/modsim_package/abaqus/rectangle_geometry.py'],
                        'destination': 'modsim_package/abaqus'}],
                   2: [{'files': ['tutorials/modsim_package/abaqus/*.py'],
                        'destination': 'modsim_package/abaqus'}],
                   3: [{'files': ['tutorials/modsim_package/abaqus/*.py',
                                  'tutorials/modsim_package/abaqus/*.inp'],
                        'destination': 'modsim_package/abaqus'}],
                   4: [{'files': ['tutorials/modsim_package/abaqus/*.py',
                                  'tutorials/modsim_package/abaqus/*.inp'],
                        'destination': 'modsim_package/abaqus'}],
                   5: [],
                   6: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                  'tutorials/modsim_package/python/rectangle_compression_nominal.py'],
                        'destination': 'modsim_package/python'}],
                   7: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                  'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                  'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py'],
                        'destination': 'modsim_package/python'}],
                   8: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                  'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                  'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py'],
                        'destination': 'modsim_package/python'}],
                   9: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                  'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                  'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py',
                                  'tutorials/modsim_package/python/post_processing.py'],
                        'destination': 'modsim_package/python'}],
                   10: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                   'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                   'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py',
                                   'tutorials/modsim_package/python/post_processing.py',
                                   'tutorials/modsim_package/python/tests/test_post_processing.py'],
                        'destination': 'modsim_package/python'}],
                   11: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                   'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                   'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py',
                                   'tutorials/modsim_package/python/post_processing.py',
                                   'tutorials/modsim_package/python/tests/test_post_processing.py',
                        ...
                        'destination': 'modsim_package/python'}],
                   12: [{'files': ['tutorials/modsim_package/python/__init__.py',
                                   'tutorials/modsim_package/python/rectangle_compression_nominal.py',
                                   'tutorials/modsim_package/python/rectangle_compression_cartesian_product.py',
                                   'tutorials/modsim_package/python/post_processing.py',
                                   'tutorials/modsim_package/python/tests/test_post_processing.py',
