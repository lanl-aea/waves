...
class AbaqusPseudoBuilder:
    ...
    :param abaqus_builder: An Builder generated by `waves.scons_extensions.abaqus_solver_builder_factory()`
    :param override_cpus: Override the task-specific default number of CPUs. This kwarg value is most useful if propagated from a
        user-specified option at execution time. If None, Abaqus Pseudo-Builder tasks will use the task-specific
        default.
    """
    def __init__(
            self,
            abaqus_builder: SCons.Builder.Builder,
    ...
    def __call__(
        ...
        :param user: User subroutine. Default: None.
        ...
        :param extra_options: Additional Abaqus options to supply to builder. Should not include any Abaqus options available as kwargs,
            e.g. cpus, oldjob, user, input, job.
        **builder_kwargs: Any additional kwargs are passed through to the builder.
