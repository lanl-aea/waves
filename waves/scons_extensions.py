...
class AbaqusPseudoBuilder:
    ...
    :param builder: An Builder generated by `waves.scons_extensions.abaqus_solver_builder_factory()`
    ...
    def __call__(
        ...
        **builder_kwargs: Any additional kwargs are passed through to the builder.
        ...
        .. code-block:: python
            ...
            import waves.scons_extensions.AbaqusPseudoBuilder
        ...
        .. code-block:: python
            ...
            env.AddMethod(
                waves.scons_extensions.AbaqusPseudoBuilder(builder=env.AbaqusSolver, override_cpus=env.GetOption("solve_cpus")),
                "Abaqus")
